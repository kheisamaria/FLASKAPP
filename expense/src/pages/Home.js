...
function Home() {
	...
	// balance
	const [balance, setBalance] = useState(0); // INPUT BALANCE OF THE POPUP DIALOG IS STORED HERE
	...
	const handleConfirm = (balanceToAdd) => {
		console.log("Balance to be added: ", balanceToAdd);
		setBalance(balanceToAdd);
		closePopup();
	};
