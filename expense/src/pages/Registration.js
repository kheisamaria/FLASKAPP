  ...
  return (
    <div className="bg-blue-950 h-screen w-screen flex">
      <div className="bg-yellow-500 h-full w-2/5 px-12 flex flex-col items-start text-white justify-end gap-y-3 py-52">
        ...
        <div className="mt-4">
          <span className="text-2xl">It all starts with a simple step.</span>{" "}
          <br />
        ...
        <div className="h-[660px] w-[800px] border border-indigo-950 bg-white shadow-2xl rounded-lg flex flex-col text-blue-950 px-8 py-6">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-y-4 mt-6">
              ...
              <div className="w-full flex flex-row gap-x-6 ">
                <div className="w-2/4">
                  <label className="text-xs font-thin">Password</label>
                  <input
                    type="password"
                    name="password"
                    onChange={handleChange}
                ...
                <div className="w-2/4">
                  <label className="text-xs font-thin">Confirm Password</label>
                  <input
                    type="password"
              ...
              <div className="w-full flex flex-row ">
                <div className="w-full">
                  <label className="text-xs font-thin">Starting Balance</label>
                  <input
                    type="number"
                    name="balance"
                    onChange={handleChange}
