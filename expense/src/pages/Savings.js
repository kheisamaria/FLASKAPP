...
function Savings() {
	...
	const handleUpdateSavings = (updatedSavingsData) => {
		console.log("New Amount: ", updatedSavingsData.amount);
		console.log("New Description: ", updatedSavingsData.description);
		console.log("New Category: ", updatedSavingsData.category);

		//INPUT NEW TIME AND DATE
		// console.log("New Date: ", updatedSavingsData.date);
		// console.log("New Time: ", updatedSavingsData.time);

		console.log("User ID: ", updatedSavingsData.user_id);
		console.log("Savings ID: ", updatedSavingsData.savings_id);
	};
